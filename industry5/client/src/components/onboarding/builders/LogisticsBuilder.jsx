...
const LogisticsBuilder = ({ onComplete }) => {
    const [attributes, setAttributes] = useState(INDUSTRY_PRESETS.logistics.attributes);
        ...
        <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center py-12 px-4 animate-in fade-in duration-500">
            <div className="max-w-4xl w-full">
                ...
                <div className="grid gap-8">
                    ...
                    {/* Variable Costs */}
                    <Section
                        title="Variable Costs (Fuel, Driver Overtime)"
                    ...
                    {/* Fixed Costs */}
                    <Section
                        title="Fixed Costs (Fleet, Warehouse)"
                        color="text-red-400"
